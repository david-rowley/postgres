...
/* ----------------
 *
 *		Plan Target List node
 *
 * <Insert comment here>
 * ----------------
 */
typedef struct PlanTargetList
{
	NodeTag		type;
	...
	/* Targets */
	TargetEntry   *targets pg_node_attr(array_size(n_targets));
} PlanTargetList;
...
typedef struct Plan
{
	...
	PlanTargetList   *targetlist;		/* target list to be computed at this
										 * node */
...
typedef struct IndexOnlyScan
{
	...
	List	   *indexorderby;	/* list of index ORDER BY exprs */
	PlanTargetList   *indextlist;		/* TargetEntry list describing index's cols */
	ScanDirection indexorderdir;	/* forward or backward or don't care */
} IndexOnlyScan;
...
typedef struct ForeignScan
{
	...
	PlanTargetList   *fdw_scan_tlist; /* optional tlist describing scan tuple */
...
typedef struct CustomScan
{
	...
	PlanTargetList   *custom_scan_tlist;	/* optional tlist describing scan tuple */

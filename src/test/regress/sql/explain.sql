...
-- should fail
select explain_filter('explain (analyze, buffers off, generic_plan) select unique1 from tenk1 where thousand = $1');
...
select explain_filter('explain (memory, analyze, buffers off, format json) select * from int8_tbl i8');

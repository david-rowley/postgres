...
count_common_leading_pathkeys_unordered(List *keys1, List *keys2)
{
	...
	/* No pointing in searching keys2 when keys1 is empty */
	if (keys1 == NIL)
		return 0;
						  ...
						  List *pathkeys)
{
	 ...
	 * of the pathkeys does not matter here as GroupAggregate for these
	 * operations can take advantage of Paths presorted by any of the GROUP
	 * BY/DISTINCT pathkeys.
	 */
